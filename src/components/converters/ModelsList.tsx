            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr
                  ...
                  onClick={() =>
                    setSelectedRow(
                      selectedRow === "AD30-2SD40" ? null : "AD30-2SD40",
                    )
                  }
                >
                ...
                <tr
                  ...
                  onClick={() =>
                    setSelectedRow(
                      selectedRow === "AD30-2SD75" ? null : "AD30-2SD75",
                    )
                  }
                >
                  <td className="border border-gray-300 px-3 py-2 text-center font-medium whitespace-nowrap">
                ...
                <tr
                  ...
                  onClick={() =>
                    setSelectedRow(
                      selectedRow === "AD30-2S1D5" ? null : "AD30-2S1D5",
                    )
                  }
                >
                  <td className="border border-gray-300 px-3 py-2 text-center font-medium whitespace-nowrap">
                ...
                <tr
                  ...
                  onClick={() =>
                    setSelectedRow(
                      selectedRow === "AD30-2S2D2" ? null : "AD30-2S2D2",
                    )
                  }
                >
                  <td className="border border-gray-300 px-3 py-2 text-center font-medium whitespace-nowrap">
