...
const Index = () => {
  return (
    <SEOWrapper
      title="Технологии Автоматизации Производств | Шкафы управления, корпуса AISI304, Люки, Частотные Преобразователи"
      ...
      structuredData={{
        ...
        description:
          "Электротехнические корпуса из нержавеющей стали марки AISI304 и AISI316 для агрессивных условий эксплуатации",
        image:
